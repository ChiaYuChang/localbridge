...
- **Observed-At**: `2026-09-24T00:03:32Z - host-parity sealed; working clean`
- **Dirty Status**: `clean`
- **Milestone**: `COMMIT_SEALED - feat(host): host-parity defaults + installer preflight + check tool; local only, no push`
- **Next Pickup Item**: `--test stdio plan; config-defaults (~/.config/localbridge) parked`
